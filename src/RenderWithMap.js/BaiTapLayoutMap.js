...
export default class BaiTapLayoutMap extends Component {
  ...
  renderPhim = () =>
    this.dataPhim.map((phim, index) => (
      <div className="col-4 mt-5" key={index} style={{ border: "none" }}>
        <div className="card text-left" style={{ height: "500px" }}>
          <div
            style={{
          ...
          <div className="card-body">
            <h4 style={{ height: "30" }} className="card-title">
              {phim.tenPhim}
            </h4>
